...
import com.arp.mynikestore.data.repo.banner.BannerRemoteDataSource
import com.arp.mynikestore.data.repo.banner.BannerRepository
import com.arp.mynikestore.data.repo.banner.BannerRepositoryImpl
import com.arp.mynikestore.data.repo.cart.CartRemoteDataSource
import com.arp.mynikestore.data.repo.cart.CartRepository
import com.arp.mynikestore.data.repo.cart.CartRepositoryImpl
import com.arp.mynikestore.data.repo.comment.CommentRemoteDataSource
import com.arp.mynikestore.data.repo.comment.CommentRepository
import com.arp.mynikestore.data.repo.comment.CommentRepositoryImpl
...
import com.arp.mynikestore.data.repo.product.ProductRemoteDataSource
import com.arp.mynikestore.data.repo.product.ProductRepository
import com.arp.mynikestore.data.repo.product.ProductRepositoryImpl
import com.arp.mynikestore.data.repo.user.UserLocalDataSource
import com.arp.mynikestore.data.repo.user.UserRemoteDataSource
import com.arp.mynikestore.data.repo.user.UserRepository
import com.arp.mynikestore.data.repo.user.UserRepositoryImpl
